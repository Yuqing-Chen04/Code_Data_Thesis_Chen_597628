...
#-----Part 2.2: Second method as the first robustness check with 3 half months in "before the mass shooting"-----#
filtered_reviews_between_2_50km_3hm <- filtered_reviews_between_2_50km %>%
